...
public class KeyWordExecution {
	public static String excelpath = System.getProperty("user.dir")+File.separator+"Huawei_Restapi1.xlsx";
	...
	public static void main(String[] args) {
		...
		excelSheet.openSheet(System.getProperty("user.dir")+File.separator+"Huawei_Restapi1.xls"); 
		...
		for (int row = 1; row < excelSheet.getRowCount(); row++) {
			...
			exeKey.runReflectionMethod("keyword.KeyWordExample",methodName, paramListObject);
		}
	}
}
